...
[ ] Add a walkthrough of actions for the defensive scenario, based on the current modus operandi of the attacker. (hint to send guards and close doors).

[ ] Add the transition from one attacker to AI attackers more noticeable. Adding a message and maybe more.
