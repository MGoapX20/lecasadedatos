...
const empty: Snapshot = { stage: 'attract', elapsedMs: 0, paused: false, catches: true, timers: true, missions: false, guided: true, uniform: false, power: true, hasPlayer: false, assisted: false, waitingForSwarm: false };
